"""The working tree, and the promise it has not kept yet.

A stub package: it lands in v0.1.0 M2. This test exists so that the workspace resolves and
